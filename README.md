...
- **23 名英雄** — 坦克、近战、远程、治疗、辅助五大职业
- **5 元素系统** — 火/冰/雷/暗/圣，元素克制 + 4 种元素反应
- **6 种族 + 6 职业羁绊** — 达到阈值触发团队增益
- **80 种技能** — 每个英雄拥有独特技能组合 + 终极技能
- **52 件装备 + 48 个遗物** — 丰富的 Build 搭配
- **37 个随机事件** — 高风险高回报的策略抉择
- **28 种敌人** — 包含 5 个Boss，支持阶段性Boss机制
- **4 幕章节** — 魔法森林 → 熔岩洞穴 → 暗影要塞 → 元素熔炉
...
├── ui/           # UI 组件 (Panel/Button/HeroCard/HUD/Codex等)
