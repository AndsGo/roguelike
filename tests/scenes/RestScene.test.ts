...
describe('RestScene', () => {
  ...
  describe('3-choice overhaul', () => {
    ...
    it('scavenge choice adds scavenge gold (interest no longer settled at rest)', () => {
      ...
      // Interest moved to per-battle settlement; rest scavenge grants only scavenge gold.
