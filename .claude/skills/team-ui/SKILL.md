...
This is a TypeScript + Phaser (web) project, so there is no engine UI specialist to spawn —
all UI is built with Phaser GameObjects. Proceed directly to implementation.
