...
Not applicable — this is a TypeScript + Phaser (web) project with no engine-specialist
agents installed. Engine-level code is handled directly by `gameplay-programmer` /
`engine-programmer`; there is no secondary specialist to spawn.
